 ...
 * without a real agy, Git, or filesystem.
 *
 ...
 *   review: (req: any) => Promise<{ ok: true, payload: unknown } | { ok: false, error: { code: string, message: string, remediation?: string } }>,
 *   quota: { check: () => ({ ok: true } | { ok: false, error: { code: string, message: string, remediation?: string } }), onSuccess: () => void, onRateLimit: () => void },
 * }} deps
 * @returns {Promise<{ ok: true, payload: unknown, scope: any } | { ok: false, error: { code: string, message: string, remediation?: string } }>}
 */
